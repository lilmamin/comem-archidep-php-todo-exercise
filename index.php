...
if (isset($_POST['action'])) {
  switch($_POST['action']) {
    ...
    case 'toggle':
      ...
      $id = $_POST['id'];
      if(is_numeric($id)) {
      $updateQuery = 'UPDATE todo SET done = !done WHERE id = \''.$id.'\''; // DONE
    ...
    case 'delete':
      ...
      $id = $_POST['id'];
      if(is_numeric($id)) {
        $deleteQuery = 'DELETE FROM todo WHERE id = '.$id; // DONE
...
$selectQuery = 'SELECT * FROM todo'; // DONE
